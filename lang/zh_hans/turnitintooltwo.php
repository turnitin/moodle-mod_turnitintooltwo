...
$string['no'] = '非';
$string['yes'] = '是';
$string['restorationassignmenterror1'] = '无法添加新课程单元至课程 {$a}';
$string['restorationassignmenterror2'] = '无法添加新课程单元至该组 - 课程 {$a}';
$string['restorationcoursecreateerror'] = '课程 {$a} 无法在 Moodle 上建立';
$string['restorationcoursecreatederror'] = '课程 {$a} 被重新建立，但在储存链接时有误';
$string['restorationcoursecreated'] = 'Turnitin 内的课程在 Moodle 上重新建立';
$string['restorationcoursegeterror'] = '无法取得 Turnitin 内的任何课程';
$string['restorationassignmentgeterror'] = '无法取得 Turnitin 内的任何作业';
