...
$string['no'] = 'Nenhum';
$string['yes'] = 'Sim';
$string['restorationassignmenterror1'] = 'Não foi possível adicionar um módulo de novo curso a esse curso {$a}';
$string['restorationassignmenterror2'] = 'Não foi possível adicionar o módulo de novo curso a essa seção {$a}';
$string['restorationcoursecreateerror'] = 'Não foi possível criar o curso {$a} no Moodle';
$string['restorationcoursecreatederror'] = 'O curso {$a} foi recriado mas ocorreu um erro ao salvar o link';
$string['restorationcoursecreated'] = 'Aula do Turnitin recriada no Moodle';
$string['restorationcoursegeterror'] = 'Não é possível obter nenhuma das aulas do Turnitin';
$string['restorationassignmentgeterror'] = 'Não é possível obter nenhum dos trabalhos do Turnitin';
