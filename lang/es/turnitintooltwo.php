...
$string['no'] = 'No';
$string['yes'] = 'Sí';
$string['restorationassignmenterror1'] = 'No se ha podido añadir un nuevo módulo del curso al curso {$a}';
$string['restorationassignmenterror2'] = 'No se ha podido añadir el nuevo módulo del curso a esa sección - curso {$a}';
$string['restorationcoursecreateerror'] = 'El curso {$a} no ha podido crearse en Moodle';
$string['restorationcoursecreatederror'] = 'El curso {$a} se ha recreado, pero ha habido un error guardando el enlace';
$string['restorationcoursecreated'] = 'La clase de Turnitin se ha recreado en Moodle';
$string['restorationcoursegeterror'] = 'No se han podido obtener ninguna de las clases de Turnitin';
$string['restorationassignmentgeterror'] = 'No se han podido obtener ninguno de los ejercicios de Turnitin';
