...
$string['turnitinrepositoryoptions_help'] = 'Använd denna inställning för att ändra de arkivalternativ som finns tillgängliga på skärmen för uppgiftskonfigurering.<br /><i>(Institutionellt arkiv är endast tillgängligt för den som har det aktiverat på sitt konto)</i>';
