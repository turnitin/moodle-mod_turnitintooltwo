...
$string['maxfilesize_help'] = '이 설정은 각각의 과제 부분에 사용자가 제출할 수 있는 최대 파일 크기를 결정합니다. 설정할 수 있는 최대 값은 코스 환경의 값 설정에 따라 다르며, Turnitin에 업로드할 수 있는 최대 허용 파일 크기 값인 40Mb 이하여야 합니다.';
...
$string['turnitininboxlayout'] = '과제 페이지 레이아웃';
$string['turnitininboxlayout_desc'] = 'Choose whether the Turnitin 과제 페이지에 내비게이션을 표시할지, 전체 폭으로 표시할지 결정하십시오.';
...
$string['migrationtoolv1list'] = '아래 목록을 사용하여 버전 {$a} 이전에 이동된 Moodle Direct V1 과제를 제거하십시오. 그러면 Moodle 채점 기록부의 부정확성이 해결됩니다. 또한 아직 V2로 이동되지 않은 V1 과제를 식별할 수도 있습니다.<br/><br/>자세한 내용은 다음을 참조하십시오. 릴리스 정보:: <a href=http://guides.turnitin.com/releasenotes>guides.turnitin.com/releasenotes</a>';
