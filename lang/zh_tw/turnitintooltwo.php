...
$string['no'] = '非';
$string['yes'] = '是';
$string['restorationassignmenterror1'] = '無法添加新課程單元至課程 {$a}';
$string['restorationassignmenterror2'] = '無法添加新課程單元至該組 - 課程 {$a}';
$string['restorationcoursecreateerror'] = '課程 {$a} 無法在 Moodle 上建立';
$string['restorationcoursecreatederror'] = '課程 {$a} 被重新建立，但在儲存鏈接時有誤';
$string['restorationcoursecreated'] = 'Turnitin 內的課程在 Moodle 上重新建立';
$string['restorationcoursegeterror'] = '無法取得 Turnitin 內的任何課程';
$string['restorationassignmentgeterror'] = '無法取得 Turnitin 內的任何作業';
