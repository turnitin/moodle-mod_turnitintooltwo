...
$string['migrationtoolv1list'] = '通过以下列表将版本 {$a} 之前迁移的 Moodle Direct V1 作业移除；这样可以解决 Moodle 成绩册中存在的误差。您也能识别尚未迁移到 V2 的 V1 作业。<br/><br/>若要了解更多信息，请参见版本说明：: <a href=https://help.turnitin.com/release-notes/turnitin-release-notes-home.htm>guides.turnitin.com/releasenotes</a>';
