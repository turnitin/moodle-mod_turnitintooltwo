...
$string['migrationtoolv1list'] = '以下の一覧を使用して、バージョン {$a} 以前に移行された Moodle Direct V1 課題を削除します。これにより Moodle 採点簿内の不正確さを解決します。V2 課題に移行していない V1 課題を判別することもできます。<br/><br/>詳細については、リリースノートを次からご覧ください。: <a href=https://help.turnitin.com/release-notes/turnitin-release-notes-home.htm>guides.turnitin.com/releasenotes</a>';
