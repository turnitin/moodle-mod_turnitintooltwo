...
$string['maxfilesize_help'] = 'Diese Einstellung legt die maximale Größe für Übermittlungen von Benutzern zu jedem Aufgabenteil fest. Die hier maximale einstellbare Größe wird auch durch die von Ihnen festgelegte Einstellung der Werte für einen Kurs bestimmt. Der Wert ist außerdem begrenzt auf die Maximalgröße von 40 MB, d. h. die Maximalgröße, die für Dateien zulässig ist, die bei Turnitin hochgeladen werden. ';
...
$string['enableperformancelogs_desc'] = 'Wenn aktiviert, wird jede Anfrage an den Turnitin-Server protokolliert in {tempdir}/turnitintooltwo/logs';
