...
$string['turnitinuseerater'] = 'ETS&copyを有効にする';
$string['turnitinuseerater_desc'] = 'ETS&copy文法チェックを有効にするかどうかを選択します。<br /><i>（これは、TurnitinのアカウントでETS&copy e-raterが有効になっている場合にのみ選択してください）</i>';
