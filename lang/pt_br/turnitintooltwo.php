...
$string['maxfilesize_help'] = 'Essa configuração determina o tamanho máximo do arquivo para envios de usuários para cada parte do trabalho. O valor máximo que você pode definir para esse valor é determinado pela definição de valores nas configurações do curso. Esse valor é ainda determinado pelo tamanho máximo de arquivo de 40 MB, que é o tamanho máximo permitido para o upload de arquivos para o Turnitin.';
...
$string['enableperformancelogs_desc'] = 'Se habilitado, cada solicitação no servidor do Turnitin será registrado em {tempdir}/turnitintooltwo/logs';
