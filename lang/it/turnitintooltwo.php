...
$string['no'] = 'No';
$string['yes'] = 'Sì';
$string['restorationassignmenterror1'] = 'Non è stato possibile aggiungere il nuovo modulo al corso di {$a}';
$string['restorationassignmenterror2'] = 'Non è stato possibile aggiungere il nuovo modulo alla sezione del corso di';
$string['restorationcoursecreateerror'] = 'Non è stato possibile ricreare il corso in Moodle';
$string['restorationcoursecreatederror'] = 'Il corso di {$ a} è stato ricreato, ma si è verificato un errore salvando il link';
$string['restorationcoursecreated'] = 'Classe di Turnitin ricreata in Moodle';
$string['restorationcoursegeterror'] = 'Impossibile ottenere qualsiasi classe da Turnitin';
$string['restorationassignmentgeterror'] = 'Impossibile ottenere qualsiasi compito da Turnitin';
