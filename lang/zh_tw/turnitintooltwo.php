...
$string['migrationtoolv1list'] = '使用下面的清單，來移除移轉至版本 {$a} 以前的 Moodle Direct V1 作業；這將解決任何 Moodle 成績簿中的不準確之處。您也可以藉此辨明尚未移轉至 V2 的 V1 作業。<br/><br/>如需更多資訊，請造訪版本資訊，網址：: <a href=https://help.turnitin.com/release-notes/turnitin-release-notes-home.htm>guides.turnitin.com/releasenotes</a>';
