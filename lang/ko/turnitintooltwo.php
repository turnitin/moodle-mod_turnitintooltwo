...
$string['maxfilesize_help'] = '본 환경은 각 과제 부분에 대한 사용자 제출물의 최고 파일 크기를 결정짓습니다. 이의 설정 가능한 최고 값은 코스 환경의 값들의 영향을 받습니다. 더 나아가 이의 최고 허용가능한 값은 Turnitin 최고 허용 파일 크기인 40Mb입니다.';
...
$string['no'] = '아니오';
$string['yes'] = '예';
$string['restorationassignmenterror1'] = '새로운 코스 모듈을 해당 코스에 추가할 수 없었습니다 {$a} ';
$string['restorationassignmenterror2'] = '새로운 코스 모듈을 해당 섹션에 추가할 수 없었습니다 - 코스 {$a} ';
$string['restorationcoursecreateerror'] = '코스 {$a}를 Moodle에서 생성할 수 없었습니다';
$string['restorationcoursecreatederror'] = '코스 {$a}가 재생성되었으나 링크를 저장하는데 오류가 있었습니다';
$string['restorationcoursecreated'] = 'Turnitin의 클래스가 Moodle에서 재생성';
$string['restorationcoursegeterror'] = 'Turnitin에서 클래스들을 가져올 수 없었음';
$string['restorationassignmentgeterror'] = 'Turnitin에서 과제들을 가져올 수 없었음';
