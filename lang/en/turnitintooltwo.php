...
$string['migrationtool_cant_migrate1'] = 'This course cannot be migrated because it exceeds the maximum number of students that the migration tool can handle on a single course.';
$string['migrationtool_cant_migrate2'] = 'This course cannot be migrated because it exceeds the maximum number of submissions that the migration tool can handle on a single course.';
$string['migrationtool_cant_migrate3'] = 'This course cannot be migrated because it has already been migrated.';
$string['migrationtool_cant_migrate4'] = 'This course cannot be migrated because it contains Moodle Direct V2 assignments.';
