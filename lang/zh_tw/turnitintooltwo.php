...
$string['turnitinrepositoryoptions_help'] = '使用此設定，變更作業設定畫面上可用的機關存放庫選項。<br /><i>(唯有帳戶啟用此功能的使用者才可使用機關存放庫)</i>';
...
$string['checkagainstnote'] = '如果您沒有勾選以下任何一方選項為”是”，原創性比對報告將不會産生。';
