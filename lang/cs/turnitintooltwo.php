...
$string['maxfilesize_help'] = 'Toto nastavení určuje maximální velikost souboru pro uživatelské odevzdání u každé části úkolu. Maximální hodnota, kterou můžete nastavit, je předurčena hodnotou zvolenou v nastavení kurzu. Tato hodnota je rovněž omezena na maximální velikost souboru o 40 MB, což je maximální povolená velikost souboru pro nahrávání souborů do sítě Turnitin.';
...
$string['enableperformancelogs_desc'] = 'Je-li povoleno protokolování výkonu sítě, bude každý požadavek zaslaný na server Turnitin zaznamenán do adresáře {tempdir}/turnitintooltwo/logs';
