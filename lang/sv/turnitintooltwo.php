...
$string['no'] = 'Nej';
$string['yes'] = 'Ja';
$string['restorationassignmenterror1'] = 'Det gick inte att lägga till en ny kursmodul till kursen {$a}';
$string['restorationassignmenterror2'] = 'Det gick inte att lägga till den nya kursmodulen till den sektionen - kurs {$a}';
$string['restorationcoursecreateerror'] = 'Kurs {$a} kunde inte skapas i Moodle';
$string['restorationcoursecreatederror'] = 'Kurs {$a} återskapades men det uppstod ett fel när länken skulle sparas';
$string['restorationcoursecreated'] = 'Klass från Turnitin har återskapats i Moodle';
$string['restorationcoursegeterror'] = 'Kunde inte hämta någon av klasserna från Turnitin';
$string['restorationassignmentgeterror'] = 'Kunde inte hämta någon av uppgifterna från Turnitin';
