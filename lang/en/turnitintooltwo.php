...
$string['migrationtoolv1list'] = 'Below is a list of V1 assignments which have not yet been migrated.';
...
$string['migrationtool:gradebookerror'] = 'Your assignment was migrated but the grades could not be confirmed in the gradebook so the V1 assignment has not been deleted.<br><br>Please check the grades in the gradebook and remove the V1 assignment once you are happy - leaving it may cause the grades to be counted in the total twice.';
$string['migrationtool:successful1'] = "Your assignment has been successfully migrated from Moodle Direct V1 to V2 and the V1 assignment has been removed.";
$string['migrationtool:successful2'] = "Your assignment has been successfully migrated from Moodle Direct V1 to V2.<br><br>However as there were more than 200 grades in this assignment the gradebook will be updated via the cron task. Once this has been completed the V1 assignment will be removed. <br><br>Please do not remove the V1 assignment yourself as this may cause the grades to not be updated correctly.";