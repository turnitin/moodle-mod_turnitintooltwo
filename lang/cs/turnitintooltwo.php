...
$string['no'] = 'Ne';
$string['yes'] = 'Ano';
$string['restorationassignmenterror1'] = 'Nelze přidat nový modul kurzu do kurzu {$a}';
$string['restorationassignmenterror2'] = 'Nelze přidat nový modul kurzu do oné sekce - kurz {$a}';
$string['restorationcoursecreateerror'] = 'Kurz {$a} nebylo možné vytvořit v systému Moodle';
$string['restorationcoursecreatederror'] = 'Kurz {$a} byl obnoven, ale došlo k chybě při ukládání odkazu';
$string['restorationcoursecreated'] = 'Kurz ze systému Turnitin byl obnoven na Moodle';
$string['restorationcoursegeterror'] = 'Nepodařilo se získat žádné kurzy ze systému Turnitin';
$string['restorationassignmentgeterror'] = 'Nepodařilo se získat žádné úkoly ze systému Turnitin';
