...
$string['no'] = 'Nein';
$string['yes'] = 'Ja';
$string['restorationassignmenterror1'] = 'Konnte diesem Kurs kein neues Modul hinzufügen {$a}';
$string['restorationassignmenterror2'] = 'Konnte das neue Kurs-Modul diesem Abschnitt nicht hinzufügen - Kurs {$a}';
$string['restorationcoursecreateerror'] = 'Kurs {$a} konnte nicht in Moodle erstellt werden';
$string['restorationcoursecreatederror'] = 'Kurs {$a} konnte wiedergestellt werden, beim Speichern des Links ist jedoch ein Fehler aufgetreten.';
$string['restorationcoursecreated'] = 'Kurs aus Turnitin in Moodle wiedererstellt';
$string['restorationcoursegeterror'] = 'Kann keine Kurse von Turnitin abrufen';
$string['restorationassignmentgeterror'] = 'Kann keine Aufgaben von Turnitin abrufen';
