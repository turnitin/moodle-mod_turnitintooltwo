...
$string['migrationtool_processexplained'] = 'We need to enter some text here to explain the migration process.<br><br>You must check all of the boxes below in order to begin the migration process.';
