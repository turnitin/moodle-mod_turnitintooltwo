...
$string['migrationtool_processexplained'] = 'We need to enter some text here to explain the migration process.<br><br>Trial migration will display a list of assignments and whether or not they can be migrated. After which you will be able to migrate them.<br><br>You must check all of the boxes below in order to begin the migration process.';
$string['migrationtool_nothingtomigrate'] = 'You do not have any Moodle Direct V1 assignments to migrate.';
$string['migrationtool_maintenancecheck'] = 'Maintenance mode must be enabled before you can migrate.';
...
$string['migrationtool_checklistheader'] = 'Checklist';
$string['migrationtool_checklist1'] = 'Checklist placeholder 1';
$string['migrationtool_checklist2'] = 'Checklist placeholder 2';
$string['migrationtool_checklist3'] = 'Checklist placeholder 3';
$string['migrationtool_checklist4'] = 'Checklist placeholder 4';
$string['migrationtool_course_text'] = 'Course:';
$string['migrationtool_can_migrate'] = 'This course can be migrated because it does not contain Moodle Direct V2 assignments.';
$string['migrationtool_cant_migrate'] = 'This course cannot be migrated because it contains Moodle Direct V2 assignments.';
$string['migrationtool_migrated'] = 'The following assignments on this course have been migrated.';
...
$string['migrationtool_course_list'] = 'The list of Moodle Direct V1 assignments on this course are as follows:';