...
$string['migrationtoolv1list'] = '아래 목록을 사용하여 버전 {$a} 이전에 이동된 Moodle Direct V1 과제를 제거하십시오. 그러면 Moodle 채점 기록부의 부정확성이 해결됩니다. 또한 아직 V2로 이동되지 않은 V1 과제를 식별할 수도 있습니다.<br/><br/>자세한 내용은 다음을 참조하십시오. 릴리스 정보:: <a href=https://help.turnitin.com/release-notes/turnitin-release-notes-home.htm>guides.turnitin.com/releasenotes</a>';
