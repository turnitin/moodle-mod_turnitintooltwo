...
$string['no'] = 'いいえ';
$string['yes'] = 'はい'
$string['restorationassignmenterror1'] = '新しいコースモジュールをコースに追加できませんでした {$a}';
$string['restorationassignmenterror2'] = '新しいコースモジュールをセクションに追加できませんでした - コース {$a}';
$string['restorationcoursecreateerror'] = 'Moodle上でコース {$a} を作成できませんでした';
$string['restorationcoursecreatederror'] = 'コース {$a} が再作成されましたが、リンクを保存中にエラーが発生しました';
$string['restorationcoursecreated'] = 'Moodle上で再作成されたTurnitinのクラス';
$string['restorationcoursegeterror'] = 'Turnitinからクラスを入手することができません';
$string['restorationassignmentgeterror'] = 'Turnitinから課題を入手することができません';
